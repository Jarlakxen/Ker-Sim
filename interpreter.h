/* cpu main header file - this has all the main data structures and
 * function prototypes. If you're just calling cpu you should look at the
 * external interface instead, in cpu.h */
