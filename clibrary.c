/* cpu mini standard C library - provides an optional tiny C standard library
 * if BUILTIN_MINI_STDLIB is defined */

#include "cpu.h"
#include "interpreter.h"

/* the cpu version string */
...
void LibraryInit() {
	...
	VersionString = TableStrRegister(CPU_VERSION);
	VariableDefinePlatformVar(NULL, "CPU_VERSION", CharPtrType, (union AnyValue *) &VersionString, FALSE);
